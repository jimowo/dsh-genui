...
function precheck(spec) {
  const notes = []
  const TYPES = new Set(['card', 'row', 'stat-row', 'stat', 'table', 'progress', 'timeline', 'chart', 'kv', 'badges', 'alert', 'code', 'collapse', 'tabs', 'buttons', 'text'])
  function scalarOK(v) {
